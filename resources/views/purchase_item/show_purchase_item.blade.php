...
<div class="container py-4">
    ...
    <div class="text-center mb-4">
        <a href="{{ route('create_purchase_item') }}" class="btn btn-lg btn-success px-4">
                        ...
                        <tbody>
                            @foreach ($purchase->purchaseItems as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit_purchase_item', $item->id) }}" class="btn btn-sm btn-outline-primary">Edit</a>
